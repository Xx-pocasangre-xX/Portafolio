...
const HeroSection = () => {
  ...
  const stats = [
    ...
    { value: 2,  suffix: '',  label: 'Sectores atendidos' },
    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 py-16">
        ...
        <div className="flex-1 max-w-2xl text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-100 mb-4 leading-tight">
            Ricardo García{' '}
            <span style={{ color: '#60a5fa' }}>Pocasangre</span>
          </h1>

          <h2 className="text-xl sm:text-2xl font-semibold mb-8" style={{ color: '#60a5fa' }}>
            Mobile Developer · Full-Stack · El Salvador
          </h2>

          <p className="text-lg text-slate-400 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
            Estudiante de Ingeniería Informática en la UCA con experiencia en desarrollo
            de aplicaciones móviles nativas y sistemas ERP empresariales. Especializado
            en Kotlin, .NET/XAF y APIs REST de alto impacto operativo.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-14">
            <a
              href="#contact"
              className="px-8 py-4 rounded-xl font-bold transform hover:-translate-y-1 transition-all duration-300 text-center"
              style={{ background: '#3b82f6', color: 'white', boxShadow: '0 10px 30px -10px rgba(59,130,246,0.5)' }}
        ...
        <div className="flex-1 flex justify-center lg:justify-end">
          <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-[400px] lg:h-[400px]">
            ...
            <div
              ...
              style={{ background: '#3b82f6', opacity: 0.18, transform: 'scale(1.1)' }}
            />
            {/* Glow blob cyan */}
            <div
              className="absolute inset-0 rounded-full filter blur-3xl animate-blob animation-delay-2000"
              style={{ background: '#22d3ee', opacity: 0.12, transform: 'scale(1.15)' }}
            />

            {/* Ring decorativo exterior */}
            <div
            ...
            <img
              ...
              style={{
                ...
                boxShadow: '0 0 40px -8px rgba(59,130,246,0.4)',
              }}
            />
